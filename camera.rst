...
Так как антенна геодезического приемника расположена внутри БВС, фазовый центр смещен относительно центральной точки объектива камеры. Величину смещения следует учитывать при точном построении ортофотопланов и 3D-моделей.

.. figure:: _static/_images/camera_position.png
   :width: 500
   :align: center

   Координаты фазового центра GNSS-приемника относительно центральной точки объектива камеры
